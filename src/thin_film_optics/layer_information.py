...
def tmmo_layer(
    *,
    ...
    Args:
        ...
        layer_type (str, optional): "GT" (geometrical thickness), or "OT" (optical
        thickness). Defaults to "GT".
        n_wavelength (float, optional): Central or reference lambda (mostly for multilayer
        structures). Defaults to -np.finfo(float).eps.
